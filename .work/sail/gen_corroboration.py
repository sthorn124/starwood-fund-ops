...
CORRO = r'''/* Draw approval (Phase 5.5; Phase 5.6 document handling): corroboration of a draw package, with no model involved.
...
# Phase 5.6: SD_supportingDocumentPrompt and SD_parseSupportingDocReading are retired (Doc Center classification and
# extraction replace the combined AI read); their text blocks stay above for the record but are no longer written.
for name, text in [("SD_getSupportingDocuments", GETDOCS), ("SD_corroborateDocuments", CORRO),
