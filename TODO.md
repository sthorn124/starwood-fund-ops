...
- **The Phase 4 approval email in Gmail.** Owner: Scott. The live one is draw 75 / step 2 ("Draw Funding Approval: Draw #67 · Tamarack Hotel & Spa Vail · $2,604,252.23 · Step 2 of 9 (Accounting Controller)", sent 2026-09-22 ~17:28 UTC to `SD Draw Demo Approvers` = scott.thorn@appian.com and sd.accountant). Eyeball: (1) section order — navy header, greeting with the red reply note, DRAW FUNDING DETAIL, DRAW DETAIL BY BUDGET CATEGORY (In this Draw / All Other Budget Categories / BUDGET), BUDGET SUMMARY, REMAINING CONTINGENCY, QIU DETAIL, APPROVAL STATUS, navy reply footer; (2) the nine-column tables render as tables with right-aligned numbers and the Current Draw column tinted; (3) the current row (▶ 2 · Accounting Controller · Daniel Osei) is highlighted amber with the blue In Progress chip and "◀ Current step — your approval is requested"; (4) QIU values as in the app ((9.4%), ($129,377,499), 0.59x, "Current QIU Model (09/22/2026)"); (5) no "[Message clipped]" (body 44.9 KB) and no stripped styling; (6) Gmail mobile: tables scroll rather than collapse. Note deltas here. *Trigger:* before the first rehearsal.
